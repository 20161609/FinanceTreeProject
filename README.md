...
1. **리포지토리 복제(Clone the repository):**
   ```bash
   git clone https://github.com/20161609/FinanceTree.git
...
<div><img width="688" alt="image" src="https://github.com/20161609/FinanceTree/assets/92266688/a954d5e1-aa76-4ee4-8cab-cd4e21d7c9e0"></div>
<div><img width="367" alt="image" src="https://github.com/20161609/FinanceTree/assets/92266688/a3530581-703a-4fba-ab48-544331a29727"></div>
<br>
<br>
...
**delete : 기존의 거래 기록을 삭제합니다(최근의).**
**delete -t : 기존의 거래 기록을 삭제합니다(최근의).**
...
**어떤 작업을 취소하거나 종료하고 싶을 때 언제든지 'q!'를 사용하세요.**
**날짜 입력은 다양한 입력 방식으로 가능합니다. (예시, 2024년 1월 18일의 경우)**
- "2024-01-18", "2024/01/18"
- "20240118", "240018" (2000년대 일 경우만 가능) 
- "24-01-18"(2000년대 일 경우만 가능), "24/01/18"(2000년대 일 경우만 가능)
